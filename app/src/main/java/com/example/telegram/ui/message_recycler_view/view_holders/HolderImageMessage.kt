...
class HolderImageMessage(view: View):RecyclerView.ViewHolder(view),MessageHolder {
    ...
    override fun drawMessage(view: MessageView) {
        if (view.from == CURRENT_UID) {
            ...
            chatUserImageMessageTime.text = view.timeStamp.toString().asTime()
        } else {
            ...
            chatReceivedImageMessageTime.text = view.timeStamp.toString().asTime()
        }
    }

    override fun omAttach(view: MessageView) {
